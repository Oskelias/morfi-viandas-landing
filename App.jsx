          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden md:flex space-x-8 text-xl font-semibold">
                ...
                <a href="#menu" className="text-gray-700 hover:text-primary transition-colors">Menú</a>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      ...
                      <p className="opacity-90 text-sm">Marcelo T de Alvear 628 - CABA</p>
                      <p className="opacity-90 text-sm">Calle 8 665, entre 45 y 46 - La Plata</p>
                    </div>
                  </div>
                </div>
